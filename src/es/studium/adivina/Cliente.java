...
public class Cliente extends JFrame implements ActionListener {
	...
	/**
	 * Dentro del método ejecutar(), el cliente lee lo que el hilo le manda (mensajes del Chat) y lo muestra en el textarea. Esto se ejecuta en un bucle del que solo se sale en el momento que el cliente pulse el botón Salir y se modifique la variable repetir
	 */
